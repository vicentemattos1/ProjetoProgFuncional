defmodule ChirpWeb.PostLive.PostComponent do
  ...
  def render(assigns) do
    ...
    <div id="post-<%= @post.id %>" class="post">
      ...
      <img alt="Qries" width=50 height=50 style="border-radius:50%; margin-left: 20px" src="https://media-exp1.licdn.com/dms/image/C4D03AQGv9ouOmGy1cw/profile-displayphoto-shrink_200_200/0/1614004824536?e=1625097600&v=beta&t=9lScLcQSnG47MzQizE5OdaGeWXOtineJJkyffAXjYi0"
